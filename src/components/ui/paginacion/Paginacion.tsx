...
interface Props {
  totalPaginas: number; // Define la interfaz de props para el componente Paginacion, indicando que debe recibir un número totalPaginas
}

export const Paginacion = ({ totalPaginas }: Props) => {
  // Declara el componente Paginacion y desestructura totalPaginas de las props
  ...
  const todasLasPaginas = generarNumeroPaginacion(currentPage, totalPaginas); // Calcula todas las páginas para mostrar en la paginación
