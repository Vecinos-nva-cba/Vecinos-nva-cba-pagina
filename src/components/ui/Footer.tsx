            ...
            <div className="flex  md:my-10 mb-5  flex-row justify-center  gap-12 md:justify-between">
              <Link href={"/"} className="">
                {/* <svg
                  ...
                  x="0px"
                  y="0px"
                  width="84px" // Reduzco el tamaño del logo en tablet
                  height="25px" // Reduzco el tamaño del logo en tablet
                  viewBox="0 0 906 275"
              ...
              <div className="flex flex-row space-x-8 items-center md:justify-between ">
                <Link href={"https://www.instagram.com/vecinosdenuevacordoba/"}>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 12 13"
                ...
                <Link href={"https://x.com/vecinosdenvacba"}>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      d="M23.954 4.569c-0.885 0.393-1.83 0.657-2.825 0.775 1.014-0.611 1.794-1.574 2.163-2.723-0.951 0.555-2.005 0.959-3.127 1.184-0.897-0.957-2.178-1.555-3.594-1.555-2.723 0-4.932 2.21-4.932 4.932 0 0.388 0.045 0.765 0.127 1.127-4.102-0.205-7.736-2.172-10.173-5.164-0.426 0.729-0.666 1.576-0.666 2.476 0 1.709 0.87 3.215 2.191 4.099-0.807-0.025-1.566-0.248-2.228-0.617v0.062c0 2.385 1.693 4.374 3.946 4.829-0.413 0.112-0.849 0.171-1.296 0.171-0.317 0-0.626-0.031-0.927-0.087 0.626 1.956 2.444 3.379 4.6 3.419-1.68 1.318-3.809 2.105-6.102 2.105-0.397 0-0.787-0.023-1.175-0.069 2.179 1.397 4.768 2.212 7.548 2.212 9.056 0 14.004-7.504 14.004-14.004 0-0.213-0.004-0.425-0.015-0.636 0.961-0.694 1.796-1.562 2.457-2.548l-0.047-0.02z"
                      fill="white"
                    />
                  </svg>
                </Link>
